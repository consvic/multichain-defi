  ...
  return (
    <nav className="fixed top-0 inset-x-0 flex justify-between items-center px-6 py-5 pr-8 border-b bg-slate-200 border-slate-900">
      ...
      <div className="flex gap-5">
        ...
        <button className="text-sm font-bold text-slate-600 rounded-lg bg-slate-200 px-4 py-3 shadow-[-2px_-2px_10px_rgba(255,255,255,1),3px_3px_10px_rgba(0,0,0,0.2)] active:shadow-[inset_-2px_-2px_5px_rgba(255,255,255,0.7),inset_3px_3px_5px_rgba(0,0,0,0.1)]">
          Connect
        </button>
      </div>
      {showWallets && (
